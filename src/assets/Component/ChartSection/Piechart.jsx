...
export default function ExpensePieChart({valueincome,valueexpanse,clicking}) {
  ...
  console.log(valueexpanse,"THis is expanse value")
    ...
    <div className="pie-card">
      ...
      <div className="pie-container">
        ...
        <div className="amountandtotalheadingINchart">
          ...
          <h2 className={clicking=="I"? "pie-title_bottom_income piechartpriceheading":"pie-title_bottom_expanses piechartpriceheading" }>₹{istotal?.toLocaleString('en-IN')} </h2>
        </div>
      </div>
    </div>
  );
